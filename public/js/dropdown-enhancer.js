(() => {
  const SELECTOR = 'select.form-control, select.premium-select, select.premium-input, select.lead-select-badge';
  ...
  const enhanceSelect = (select) => {
    ...
    wrapper.className = `app-select ${select.matches('.premium-select, .premium-input') ? 'app-select-premium' : ''} ${select.matches('.lead-select-badge') ? 'app-select-compact' : ''}`;
