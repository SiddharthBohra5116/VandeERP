...
const leadSchema = new mongoose.Schema({
  ...
  automation: {
    provider: {
      type: String,
      enum: ['instagram', 'facebook', 'website', 'whatsapp', 'linkedin', 'zapier', 'make', 'other', 'none'],
      default: 'none'
    },
...
=======
const { LEAD_SOURCES, LEAD_TYPES, LEAD_CATEGORIES, LEAD_STATUSES, LOST_REASONS, AUTOMATION_PROVIDERS } = require('../config/constants');
...
const leadSchema = new mongoose.Schema({
  ...
  leadType: { type: String, enum: LEAD_TYPES, default: 'manual' },
  category: { type: String, enum: LEAD_CATEGORIES, default: 'warm' },
  ...
  automation: {
    provider: { type: String, enum: AUTOMATION_PROVIDERS, default: 'none' },
    externalLeadId: { type: String, default: '' },
